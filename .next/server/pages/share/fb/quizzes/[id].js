...
const getServerSideProps = async context => {
  ...
  const quiz = await axios__WEBPACK_IMPORTED_MODULE_1___default()({
    method: "get",
    url: `${_url__WEBPACK_IMPORTED_MODULE_6__/* .local_backend_url */ .a9}/api/quizzes/${id}`
  }).then(res => {
    return res.data;
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((next_head__WEBPACK_IMPORTED_MODULE_2___default()), {
      children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("meta", {
        ...
        property: "og:image",
        content: `${_url__WEBPACK_IMPORTED_MODULE_6__/* .local_backend_url */ .a9}/storage/${image === null || image === void 0 ? void 0 : image.image_link}`
      })]
    }, `quizzes/${quiz.id}`), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
      style: {
        height: "100vh",
        width: "100vw",
        display: "grid",
...
var __webpack_exports__ = (__webpack_exec__(8079));
