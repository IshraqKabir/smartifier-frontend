...
/* harmony import */ var _methods_backendSendPasswordResetMail__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22);
...
const api = async (req, res) => {
  ...
  const {
    ...
    response,
    error
  } = await (0,_methods_backendSendPasswordResetMail__WEBPACK_IMPORTED_MODULE_0__.default)(email);
...
/* harmony default export */ __webpack_exports__["default"] = (async email => {
  const user = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(`${_url__WEBPACK_IMPORTED_MODULE_1__/* .backend_url */ .LL}/api/auth/send-password-reset-mail`, {
    email
  }).then(response => {
    return {
      success: true,
...
var __webpack_exports__ = (__webpack_exec__(9740));
