...
/* harmony import */ var _methods_backendSendEmailVerificationMail__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3420);
...
const api = async (req, res) => {
  ...
  const {
    ...
    response,
    error
  } = await (0,_methods_backendSendEmailVerificationMail__WEBPACK_IMPORTED_MODULE_0__.default)(email, password);
...
/* harmony default export */ __webpack_exports__["default"] = (async (email, password) => {
  const user = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(`${_url__WEBPACK_IMPORTED_MODULE_1__/* .backend_url */ .LL}/api/auth/send-email-verification-mail`, {
    email,
    password
  }).then(response => {
    return {
