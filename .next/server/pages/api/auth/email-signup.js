...
/* harmony import */ var _methods_backendEmailSignup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3628);
...
const api = async (req, res) => {
  ...
  const {
    ...
    success,
    error
  } = await (0,_methods_backendEmailSignup__WEBPACK_IMPORTED_MODULE_0__.default)(body);
...
/* harmony default export */ __webpack_exports__["default"] = (async data => {
  const user = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(`${_url__WEBPACK_IMPORTED_MODULE_1__/* .backend_url */ .LL}/api/auth/email-signup`, data).then(response => {
    return {
      success: true,
